...
``` sh
  gem install j1-template -v 2024.0.1 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2024.0.1 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
