...
then push the new tag
  ...
  git tag -a v2024.0.1 -m "v2024.0.1"
...
Then:
  ...
  git commit -am "New version 2024.0.1"
  git commit --allow-empty -m "New version 2024.0.1"
  git commit -am "Prepare new version 2024.0.1"
  git commit -am "Latest files of version 2024.0.1"
